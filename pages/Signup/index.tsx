...
import { View, ViewStyle, StyleSheet, Alert,  TextStyle, ScrollView, TouchableOpacity, Image, ImageStyle, ImageBackground, Platform } from 'react-native';
...
window.Blob = Blob
    return new Promise((resolve, reject) => {
      ...
      fs.readFile(uploadUri, 'base64')
        ...
        .then((blob) => {
          console.log('datab', blob)
         // uploadBlob = blob
         const task = reference.child('file').putFile(blob);
        ...
        .then(() => {
        //  uploadBlob.close()
          console.log(reference.getDownloadURL(), 'downloadUrl')
      ...
      <ScrollView>
        ...
        <View style={{flex:1, backgroundColor: theme.backgroundColor}}>
          <View style={[style.container, style.extraStyle, {backgroundColor: theme.backgroundColor, position: 'relative', bottom: 80}]}>
            ...
            <TouchableOpacity style={style.childContainer}   onPress={ () => openImagePicker()}>
            <Image source={girl} style={[style.logoImage2, {borderColor: theme.backgroundColor}]}/>
          </TouchableOpacity>
            <Input
